...
if __name__ == "__main__":
    ...
    print(search)
    print(f"Searching for: {search.room_type} on {search.book_date} at {search.book_time}")
    print()
    ...
    print(booking)
    print(f"Booking: {booking.room_id} for {booking.user} on {booking.book_date} at {booking.book_time}")
    print()
