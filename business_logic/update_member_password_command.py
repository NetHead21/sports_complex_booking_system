...
class UpdateMembersPasswordCommand(Command):
    ...
    def execute(self, data=None) -> tuple[bool, any]:
        ...
        try:
            ...
            if success:
                MemberInputService.display_operation_result("Password Update", member_id, True)
                return True, None
            else:
                MemberInputService.display_operation_result("Password Update", member_id, False, "Member not found")
