...
class DeleteMembersCommand(Command):
    ...
    def execute(self, data=None) -> tuple[bool, any]:
        ...
        try:
            ...
            if success:
                MemberInputService.display_operation_result("Member Deletion", member_id, True)
                return True, None
            else:
                MemberInputService.display_operation_result("Member Deletion", member_id, False, "Member not found")
